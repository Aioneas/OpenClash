...
value['rule-providers'].merge!(
  ...
  'HBOMax' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/HBOMax.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/HBOUSA/HBOUSA.yaml','interval'=>86400},
  'Netflix' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/Netflix.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Netflix/Netflix.yaml','interval'=>86400},
  'Bahamut' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/Bahamut.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Bahamut/Bahamut.yaml','interval'=>86400},
  'BiliBili' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/BiliBili.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/BiliBili/BiliBili.yaml','interval'=>86400},
  'Spotify' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/Spotify.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Spotify/Spotify.yaml','interval'=>86400},
  'Steam' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/Steam.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/Steam.yaml','interval'=>86400},
  'Telegram' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/Telegram.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Telegram/Telegram.yaml','interval'=>86400},
  'Google' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/Google.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Google/Google.yaml','interval'=>86400},
  'Microsoft' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/Microsoft.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Microsoft/Microsoft.yaml','interval'=>86400},
  'GitHub' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/GitHub.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/GitHub/GitHub.yaml','interval'=>86400},
  'OpenAI' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/OpenAI.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/OpenAI/OpenAI.yaml','interval'=>86400},
  ...
  'China' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/China.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China.yaml','interval'=>86400},
  'Lan' => {'type'=>'http','behavior'=>'classical','path'=>'./rule_provider/Lan.yaml','url'=>'https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Lan/Lan.yaml','interval'=>86400}
)
